                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.classes.store') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="description" id="description" class="form-control" placeholder="Enter Class Description"></textarea>
                                        @error('description')
                                            <div class="text-red-500 text-sm">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <button type="submit" class="btn btn-success btn-sm mb-2">Create Class</button>
