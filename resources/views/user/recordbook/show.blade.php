...
<div class="container record-book-container">
    <div class="d-flex justify-content-between align-items-center mb-3"> <h4>Record Book — {{ $user->name }}</h4> <div> <a class="btn btn-secondary" href="{{ route('user.recordbook.pdf',$user) }}">Download PDF</a> <button class="btn btn-outline-primary" onclick="window.print()">Print</button> </div> </div>
