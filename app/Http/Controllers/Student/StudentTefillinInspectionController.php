...
class StudentTefillinInspectionController extends Controller
{
    public function recordBook(){
        ...
        return view('student.recordbook.index', compact('users'));
    }
    ...
    public function show(User $user){
        ...
        return view('student.recordbook.show', compact('user','tefillin','mezuza','batim'));
    }
    ...
    public function pdf(User $user){
        ...
        ->get()
        ->unique('type');
        $pdf = Pdf::loadView('student.recordbook.pdf', compact('user','tefillin','mezuza','batim'))
