...
class StudentTefillinInspectionController extends Controller
{
    public function index()
    {
        $inspections = TefillinInspection::where('user_id', Auth::id())->latest()->paginate(10);

        return view('student.tefillin_inspections.index', compact('inspections'));
    }
    ...
    public function create()
    {
        ...
        return view('student.tefillin_inspections.create', compact('sides','parts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('student.tefillin_inspections.index')
    ...
    public function edit(TefillinInspection $tefillin_inspection)
    {
        ...
        return view('student.tefillin_inspections.edit', [
