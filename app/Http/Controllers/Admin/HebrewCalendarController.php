...
class HebrewCalendarController extends Controller
{
    public function index()
    {
        ...
        $calendar = $this->getCalendarData($date);
        return view('admin.hebcalendar.index', $calendar);
    }
    ...
    public function downloadPdf()
    {
      ...
      private function getCalendarData($startDateYmd, $startMonth = 1, $numMonths = 12)
    {
        $eventsByMonth = [];
        $hebrewTitles = [];
        $hebrewMonthRanges = [];
        ...
        for ($i = 0; $i < $numMonths; $i++) {
            ...
            $key = $i + 1;
            $gregorianTitles[$key] = Carbon::create($currentYear, $month, 1)->format('F');
    ...
    {
        return view('admin.hebcalendar.convertor');
    }
